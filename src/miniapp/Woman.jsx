...
export default function Woman(props) {
  return (
    <div className="divsneak">
      <h1 id="hsnaek">Woman</h1>
      <div className="container">
        {props.tab.map((a, k) => {
          return (
              <div className="Sneak" key={k}>
                <Link to={`/pages/pagsneak`} state={a} id="Link"><img id="imgsneak" src={a.src} alt={a.name} /></Link>
              ...
              <i class="fa fa-heart" style={{ fontSize: 27, color: "white",cursor: 'pointer'}}></i>
            </button>
              </div>
